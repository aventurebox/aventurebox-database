/*
 ...
 Data       : 18-07-2023
 Description: Cria tabela post_tag_profile_profile e insere novos tipos de notificações
*/

CREATE TABLE post_tag_profile_profile(
...
INSERT INTO notification_type(id, name) VALUES (21, 'post_tag_profile_profile');
...
INSERT INTO migration VALUES(60, 'Cria tabela post_tag_profile_profile e insere novos tipos de notificações', '2023-7-18', now());