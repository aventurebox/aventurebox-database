...
alter table user_profile add email_failed boolean default false;

INSERT INTO migration VALUES(3,'Altera tamanho da coluna user_ das tabelas user_temp, user_login, user_login_log. Altera user_profile nova coluna email_failed','2017-06-21', now());
